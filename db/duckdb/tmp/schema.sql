...
CREATE TABLE movie_plots_ld(title VARCHAR, stars VARCHAR[], directors VARCHAR[], "year" INTEGER, genre VARCHAR[], runtime INTEGER, "ratingCount" INTEGER, plot VARCHAR, summary VARCHAR, imdb_rating FLOAT, source VARCHAR);
